...
/**
 * The TetrominoFactory class serves to facilitate and reduce
 * the creation of specific pieces to a single method call.
 * <p>
 * All of the pieces generated by a TetrominoFactory instance will
 * have their position set to very close to the top of an
 * imaginary board with finite dimensions.
 * <p>
 * Again, despite the name, the pieces may or may not be of any
 * size.
 */
public class TetrominoFactory {
    ...
    /**
     * Creates a new TetrominoFactory with dimensions as
    ...
    /**
     * Creates and returns a list containing all the Tetrominoes
     * that this TetrominoFactory can create.
     * @return
     */
